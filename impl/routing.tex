...
Similar problems rise with events and event requests.
Debugger can send event requests to the JVM which will specify for which kind of events the debugger wishes to get notifications.
...
In the above code snippets, the \inlinecode{CompositeEventCommand} object has been parsed from a command packet received from the JVM.
