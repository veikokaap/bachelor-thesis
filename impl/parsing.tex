...
The above code snippet shows how the bytes are parsed for reading for a breakpoint event in the method \inlinecode{read} and how the parsed data is processed back into bytes in method \inlinecode{write}.
