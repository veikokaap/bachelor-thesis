...
\begin{tikzpicture}[every node/.style={font=\normalsize,
  ...
  \fill
    (\PROJVM 2.south)
      node[, below right=-3mm and -20mm, fill=white, text=black] {Change id: 1 $\rightarrow$ 2};
  \draw [-latex, black]
    (\PRO 5) -- (\JVM 5);
  \fill
    (\PROJVM 5)
  ...
  \fill
    (\PROJVM 12.south)
      node[, below right=-3mm and -20mm, fill=white, text=black] {Change id: 1 $\rightarrow$ 3};
  \draw [-latex, black]
    (\PRO 15) -- (\JVM 15);
  \fill
    (\PROJVM 15)
