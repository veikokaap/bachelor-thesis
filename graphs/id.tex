...
\begin{tikzpicture}[every node/.style={font=\normalsize,
  ...
  \fill
    (\SEDEPRO 7.south)
      node[, below left=-3mm and -16mm, fill=white, text=black] {Change id: 2 $\rightarrow$ 1};
  \draw [-latex, black]
    (\PRO 8) |- +(0.6,0) |- (\PRO 10);
  \draw [-latex, black]
  ...
  \fill
    (\SEDEPRO 17.south)
      node[, below left=-3mm and -16mm, fill=white, text=black] {Change id: 3 $\rightarrow$ 1};
  \draw [-latex, black]
    (\PRO 18) |- +(0.6,0) |- (\PRO 20);
  \draw [-latex, black]
    (\PRO 20) -- (\SEDE 20);
...
\end{tikzpicture}
\captionof{figure}{\it{Illustration of the proxy server changing packet ids for debuggers.}}
\label{graph:id}
\end{document}
