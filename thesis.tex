...
\subfile{jvm_debugging/jvm_debugging.tex}
...
\subsection{Java Virtual Machine Tool Interface}
\label{sec:jvmti}
\subfile{jpda/jvmti.tex}

\subsection{Java Debugger Wire Protocol}
\label{sec:jdwp}
